package com.tripkipedia.ui.settings.privacyPolicy.viewmodel
 ...
 */
class PrivacyPolicyViewModel(application: Application) : BaseViewModel(application) {

    private lateinit var binder: ActivityPrivacyPolicyBinding
    lateinit var mContext: Context


    fun setBinder(binder: ActivityPrivacyPolicyBinding) {
        this.binder = binder
        ...
        binder.topbar.tvTitle.setText("Privacy Policy")
        init()
