package com.tripkipedia.ui.settings.contactUs.viewmodel
...
class ContactUsViewModel(application: Application) : BaseViewModel(application) {
    ...
    private lateinit var binder: ActivityContactUsBinding
    lateinit var mContext: Context


    fun setBinder(binder: ActivityContactUsBinding) {
        this.binder = binder
        ...
        binder.topbar.isThreeDotsShow = true
        binder.topbar.tvTitle.setText("Arthur Fisher")
        init()
