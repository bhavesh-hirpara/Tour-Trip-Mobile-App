package com.tripkipedia.ui.settings.notificationSettings.viewmodel
...
class NotificationSettingsViewModel(application: Application) : BaseViewModel(application) {
    ...
    private lateinit var binder: ActivityNotificationsSettingsBinding
    lateinit var mContext: Context


    fun setBinder(binder: ActivityNotificationsSettingsBinding) {
        this.binder = binder
        ...
        binder.topbar.tvTitle.setText("Notification Settings")
