package com.tripkipedia.ui.tCoinsHistory.utils
...
class TCoinAdapter() : RecyclerView.Adapter<TCoinAdapter.MyViewHolder>() {
    ...
    class MyViewHolder(internal var itemBinder: ItemTCoinsHistoryBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val v: ItemTCoinsHistoryBinding =
            DataBindingUtil.inflate<ItemTCoinsHistoryBinding>(
                inflater,
                R.layout.item_t_coins_history, parent, false
