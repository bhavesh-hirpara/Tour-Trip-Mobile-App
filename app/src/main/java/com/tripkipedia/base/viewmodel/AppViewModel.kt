...
import com.tripkipedia.interfaces.DateEventListener
...
open class AppViewModel : AndroidViewModel {
    ...
    fun openLoginPage() {
        val intent =
            Intent(Intent.ACTION_VIEW, Uri.parse(getContext().getString(R.string.ago_login)))
