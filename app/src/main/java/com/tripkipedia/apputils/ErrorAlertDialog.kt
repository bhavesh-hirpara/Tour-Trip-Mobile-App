...
import com.tripkipedia.databinding.DialogExceptionDialogBinding
/**
...
class ErrorAlertDialog {
  ...
  fun show() {
    ...
    try {
      var pd: AlertDialog.Builder
              = AlertDialog.Builder((context as Activity), R.style.MyAlertDialogStyle)
